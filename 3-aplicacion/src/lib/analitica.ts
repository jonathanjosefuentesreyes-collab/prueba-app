// ID de Google Analytics 4. Cuando crees la propiedad GA4 (analytics.google.com) y obtengas
// tu "Measurement ID" (formato G-XXXXXXXXXX), pégalo aquí y la analítica se activa sola.
...
export const GA_MEASUREMENT_ID = "G-W7GD1NQXY4";
